...
# Passport-record date fields must stay chronologically consistent: date_of_birth < issue_date < expiry_date
...
def generate_generic_value(
    ...
    # Free-text placeholders are replaced by LLM enrichment in the production generation path.
